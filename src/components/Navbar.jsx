      ...
      <nav className='w-full relative z-[5]'>
        <div className='flex items-center justify-between py-6 relative max-md:px-4'>
          ...
          <ul className='list-none md:flex hidden justify-between gap-10'>
            {
              navLinks.map(link => (
                <li key={link.id} className='cursor-pointer text-white transition duration-100 hover:text-gray-300 text-[16px]'>
          ...
          <div className="auth-btns md:flex hidden items-center  justify-between gap-10">
            <a href="#" className='text-white transition duration-100 hover:text-gray-300'>Login</a>
            <a href="#" className='rounded-[40px] py-4 px-8 bg-white text-black hover:bg-gray-300 transition duration-100'>Sign Up</a>
          </div>
