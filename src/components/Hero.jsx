...
const Hero = () => (
  <div id="home" className="pt-24 h-screen">
    ...
    <div className="hero-tab max-w-[370px] sm:max-w-[1076px] mx-auto relative mt-14 md:mt-24">
      <div
        data-aos="fade-down"
        className="tab-twitter w-[300px] sm:w-[348px] absolute z-[4] right-[40px] sm:left-0"
      >
        <img src={tab4} alt="tab4" className='-rotate-6' />
      </div>
      <div
        data-aos="fade-down"
        className="tab-pinterest w-[300px] sm:w-[348px] absolute right-[40px] sm:left-[143px] bottom-[-150px] sm:bottom-[-136px] z-[3]"
      >
        <img src={tab3} alt="tab3" className='-rotate-3' />
      </div>
      <div
        data-aos="fade-down"
        className="tab-fb w-[300px] sm:w-[348px] absolute right-[40px] sm:left-[390px] top-32 sm:top-0 z-[2]"
      >
        <img src={tab2} alt="tab2" className='rotate-6' />
      </div>
      <div
        data-aos="fade-down"
        className="tab-dribble w-[300px] sm:w-[348px] absolute z-[1] right-[40px] bottom-[-280px] sm:bottom-[-137px]"
      >
