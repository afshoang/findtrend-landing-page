...
const NewTab = () => (
    <div className='w-full sm:max-w-[850px] text-center flex flex-col justify-between items-center gap-14 py-20 sm:py-36'>
      <h1 className='text-3xl sm:text-6xl font-bold max-sm:mb-5'>Open new tabs is sh*t</h1>
      ...
      <p className='text-sm sm:text-lg max-sm:mt-5 max-sm:px-5'>A solution for your browser tabs and don’t make your device get slower over time. Get ease and faster to discover a trend with just one tab.</p>
    </div>
  )
