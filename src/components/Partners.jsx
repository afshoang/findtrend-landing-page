  ...
  return (
    <div className="container mx-auto py-20 sm:py-36 px-5">
      ...
      <div className='grid grid-cols-2 ss:grid-cols-4 auto-rows-auto gap-3.5'>
        {
          brandLinks.map(brand => <div key={brand.id} className='p-6 md:p-10 bg-gray300 flex justify-center items-center rounded-lg'>
            <img src={brand.logo} className='max-w-[100px] sm:max-w-[140px] md:max-w-[190px] max-h-[30px] md:max-h-[40px]' />
          </div>
          )
        }
      </div>
